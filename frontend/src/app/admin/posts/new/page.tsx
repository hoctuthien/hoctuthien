      ...
      <div className="h-full flex flex-col -m-6 lg:-m-10 bg-white">
        ...
        <div className="h-16 border-b border-slate-100 px-6 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-2">
            <Button label="Preview" variant="secondary" iconLeft={<Icon name="Eye" size={16} />} className="!px-4 !py-2 !rounded-xl !text-xs" />
            ...
            <Button variant="text" label={<Icon name="Settings" size={18} />} className="!p-2 text-slate-400" />
          </div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2 p-3 bg-white border border-slate-200 rounded-xl min-h-[100px] shadow-sm">
                  <Badge variant="neutral" className="!rounded-lg">UI Design</Badge>
                  <Badge variant="neutral" className="!rounded-lg">Trends 2026</Badge>
