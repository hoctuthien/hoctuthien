...
export const MetricsGrid: React.FC<MetricsGridProps> = ({ isMentor, stat1, stat2, stat3, stat4 }) => {
  const tExtracted = useTranslations('Extracted.appDashboardDashboardComponentsMetricsGrid');
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-white border border-[#E2E8F0] p-5 rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.005)] flex items-center gap-4 hover:shadow-md transition-all duration-300">
        ...
        <div className="flex flex-col gap-0.5 min-w-0">
          <span className="text-[10px] text-[#64748b] font-black uppercase tracking-wider block truncate">
            {isMentor ? tExtracted('khoaHocDaTao') : tExtracted('khoaHocDaDangKy')}
          </span>
      ...
      <div className="bg-white border border-[#E2E8F0] p-5 rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.005)] flex items-center gap-4 hover:shadow-md transition-all duration-300">
        ...
        <div className="flex flex-col gap-0.5 min-w-0">
          <span className="text-[10px] text-[#64748b] font-black uppercase tracking-wider block truncate">{tExtracted('lichHenSapToi')}</span>
      ...
      <div className="bg-white border border-[#E2E8F0] p-5 rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.005)] flex items-center gap-4 hover:shadow-md transition-all duration-300">
        ...
        <div className="flex flex-col gap-0.5 min-w-0">
          <span className="text-[10px] text-[#64748b] font-black uppercase tracking-wider block truncate">
            {isMentor ? tExtracted('hocVienDangGiangDay') : tExtracted('soGioHocTichLuy')}
          </span>
