...
export type DateRangePickerStatus = "default" | "success" | "warning" | "error";
      ...
      <Popover.Root>
        <Popover.Trigger asChild>
          <button
            ...
            disabled={disabled}
            className={cn(
              "group/date-range-picker relative flex items-center gap-3 transition-all duration-300 w-full outline-none border",
              sizeStyles[size],
              ...
              // Selected State Look (if range is present and default)
              range?.from && !disabled && status === "default" && "text-[#181C20] font-medium",
              !range?.from && status === "default" && "text-[#727785]",
          ...
          >
            <CalendarIcon
              ...
              className={cn(
                ...
                !disabled && status === "default" && "group-hover/date-range-picker:text-primary",
                range?.from && status === "default" ? "text-primary" : "text-[#727785]",
