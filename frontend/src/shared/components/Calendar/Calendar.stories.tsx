        ...
        <div className="max-w-4xl mx-auto w-full">
          <header className="mb-12">
            ...
            <p className="text-lg text-slate-500 max-w-2xl leading-relaxed">
              ...
              clarity, high-contrast interaction states, and editorial white
              space.
            </p>
          </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            <div className="flex flex-col gap-4">
              <h2 className="text-sm font-black uppercase tracking-widest text-[#005BBF]">
                Mini Calendar View
              </h2>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center justify-between p-4 bg-white rounded-2xl border border-slate-100 shadow-sm">
                    ...
                    <span className="size-8 flex items-center justify-center bg-slate-100 rounded-lg text-slate-900 font-bold text-xs text-[#005BBF]">
                      12
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-[#005BBF] rounded-2xl shadow-lg ring-4 ring-blue-100">
                    ...
                    <span className="size-8 flex items-center justify-center bg-white rounded-lg text-[#005BBF] font-bold text-xs">
                      05
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-slate-100 rounded-2xl opacity-60">
                    ...
                    <span className="size-8 flex items-center justify-center bg-slate-200 rounded-lg text-slate-400 font-bold text-xs">
                      28
                    </span>
                  </div>
                </div>
