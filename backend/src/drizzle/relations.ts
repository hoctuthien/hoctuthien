...
import { users, userSessions, mentorProfiles, mentorAvailabilities, courses, courseCategories, categories, payments, courseBookings, courseReviews, userReviews, systemConfig, penaltyTickets, conversations, messages, notifications } from "./schema";
...
export const courseBookingsRelations = relations(courseBookings, ({one, many}) => ({
	course: one(courses, {
