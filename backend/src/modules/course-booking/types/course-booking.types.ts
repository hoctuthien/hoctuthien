...
export type UpdateCourseBookingByMenteeInput = z.infer<typeof updateCourseBookingByMenteeSchema>;
export type FindCourseBookingsQuery = z.infer<typeof findCourseBookingsQuerySchema>;
